...
const NoFinishedProjects = () => {
  return (
    <h3 className="no-projects-header">There are no finished projects.</h3>
  );
};
...
const FinishedProjects = () => {
  if (DUMMY_SUGGESTIONS.length > 0) {
    return (
      <>
        <h3 className="page-title">Already finished projects:</h3>
